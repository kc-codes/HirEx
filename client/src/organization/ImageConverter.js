...
const base64ToHttps = (dataURI) => {
  ...
  async function uploadToCloudinary(base64Image) {
    // const cloudName = "dgdwjxrza"; // Replace with your Cloudinary cloud name
    // const apiKey = "825316866283598"; // Replace with your Cloudinary API key
    // const apiSecret = "QHg5ETW4iVhyXMYU6o8JlKlbk6E"; // Replace with your Cloudinary API secret
    // const uploadPreset = "oozgdcvf"; // Replace with your Cloudinary upload preset name
