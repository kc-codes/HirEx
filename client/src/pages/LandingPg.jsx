        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10">
            <div className="flex justify-evenly items-start flex-wrap">
              ...
              >
                <FontAwesomeIcon icon={faFileAlt} className="text-white text-4xl" />
              </motion.div>
              <Link to="/resume">  {/* Target: /resume */}
                <button
                  onClick={() => {
                    setDisplay("resumebuilder"); // Set state as needed (optional)
                  }}
              ...
              <Link to="/resumebuilder">  {/* Target: /resumebuilder */}
                <button
                  onClick={() => {
                    setDisplay("resumebuilder2"); // Set state as needed (optional)
                  }}
              ...
              <Link to="/analyzer">
                <div className="flex flex-col items-center">
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 2 }}
                    className="w-48 h-48 bg-red-500 rounded-full flex justify-center items-center shadow-lg mb-4 hover:bg-red-600"
                  >
                    <FontAwesomeIcon
                      icon={faFileAlt}
                      className="text-white text-4xl"
